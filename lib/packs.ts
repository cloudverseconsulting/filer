...
// Each creates a RuleCondition. Wrap multiple conditions in a group via r().
...
// Domain: source domain is any of these values
const D = (values: string[]): RuleCondition =>
  cond("source_domain", "is_any_of", values.join(", "))

// Filename: filename contains any of these terms
const F = (values: string[]): RuleCondition =>
  cond("filename", "contains_any_of", values.join(", "))

// Extension: file extension is any of these
const E = (values: string[]): RuleCondition =>
  cond("file_extension", "is_any_of", values.join(", "))

// URL: full URL contains any of these terms
const U = (values: string[]): RuleCondition =>
  cond("full_url", "contains_any_of", values.join(", "))

// Page title: page title contains any of these terms
const T = (values: string[]): RuleCondition =>
  cond("page_title", "contains_any_of", values.join(", "))

// URL path: URL path contains any of these terms
const P = (values: string[]): RuleCondition =>
  cond("url_path", "contains_any_of", values.join(", "))
...
function r(
  ...
  logic: "AND" | "OR",   // AND = all must match, OR = any can match
  rename: string,
  folder: string,
  priority: number
): Rule {
  const group: ConditionGroup = { id: gid(), logic, conditions }
  return {
    id, name, pack,
  ...
  social_media: {
    ...
    rules: [
      r("sm_001", "Content Calendar", "social_media",
        [F(["content calendar", "editorial", "social plan", "content plan"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Strategy/Calendars/", 1),
      r("sm_002", "Analytics Report", "social_media",
        [D(["later.com", "buffer.com", "hootsuite.com", "sproutsocial.com", "iconosquare.com"])], "OR",
      ...
      r("sm_004", "Influencer Contract", "social_media",
        [F(["influencer", "ugc", "partnership", "brief"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Contracts/", 4),
    ]
  },
  ...
  it_admin: {
    ...
    rules: [
      ...
      r("it_002", "Software License", "it_admin",
        [F(["license", "license key", "serial", "activation"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Licenses/", 2),
      r("it_003", "Audit / Compliance Report", "it_admin",
        [F(["audit", "compliance", "soc2", "iso27001", "hipaa", "security report"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Compliance/", 3),
      r("it_004", "Network / Config Export", "it_admin",
        [F(["config", "backup", "export"]), E([".cfg", ".conf", ".yaml", ".json"])], "OR",
    ...
    rules: [
      r("tv_001", "Flight Booking", "traveler",
        [D(["google.com/flights", "kayak.com", "expedia.com", "united.com", "delta.com", "aa.com", "southwest.com"]),
         F(["boarding pass", "itinerary", "e-ticket"])], "OR",
  ...
  fitness: {
    ...
    rules: [
      r("fit_001", "Workout Plan", "fitness",
        [F(["workout", "training plan", "program", "routine"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Fitness/Plans/", 1),
      r("fit_002", "Nutrition Guide", "fitness",
        [F(["nutrition", "meal plan", "diet", "macros", "calories"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Fitness/Nutrition/", 2),
      r("fit_003", "Wearable / App Export", "fitness",
        [D(["connect.garmin.com", "strava.com", "fitbit.com", "apple.com", "myfitnesspal.com"])], "OR",
  ...
  energy: {
    ...
    rules: [
      r("en_001", "Meter / Usage Data", "energy",
        [F(["meter data", "usage report", "interval data", "smart meter"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Operations/Meter Data/", 1),
      r("en_002", "Compliance Report", "energy",
        [F(["compliance", "ferc", "nerc", "epa", "emissions"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Compliance/", 2),
      r("en_003", "Contractor Invoice", "energy",
        [F(["invoice", "contractor", "maintenance", "field service"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Finance/Invoices/", 3),
      r("en_004", "Utility Bill", "energy",
        [F(["utility bill", "electric bill", "gas bill", "water bill"])], "OR",
  ...
  actor: {
    ...
    rules: [
      r("act_001", "Script / Sides", "actor",
        [F(["script", "sides", "dialogue", "screenplay"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Projects/Scripts/", 1),
      r("act_002", "Audition Material", "actor",
        [F(["audition", "self-tape", "callback"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Auditions/", 2),
      r("act_003", "Contract / Deal Memo", "actor",
        [F(["contract", "deal memo", "booking confirmation", "rider"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Contracts/", 3),
      r("act_004", "Agent / Casting Platform", "actor",
        [D(["actors access", "casting frontier", "breakdown services", "castingnetworks.com"])], "OR",
  ...
  game_dev: {
    ...
    rules: [
      r("gd_001", "Game Build", "game_dev",
        [E([".exe", ".apk", ".ipa", ".pkg", ".dmg"]), F(["build", "release", "alpha", "beta"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Builds/", 1),
      r("gd_002", "Asset Pack", "game_dev",
        [D(["assetstore.unity.com", "fab.com", "itch.io", "kenney.nl"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Assets/", 2),
      r("gd_003", "Design Document", "game_dev",
        [F(["gdd", "game design document", "design doc", "spec"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Design/", 3),
      r("gd_004", "Playtesting Notes", "game_dev",
        [F(["playtest", "feedback", "notes", "session"])], "OR",
  ...
  writer: {
    ...
    rules: [
      r("wr_001", "Manuscript / Draft", "writer",
        [F(["manuscript", "draft", "chapter", "novel", "story"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Writing/Manuscripts/", 1),
      r("wr_002", "Editorial Notes", "writer",
        [F(["editorial", "editor notes", "feedback", "revision", "tracked"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Writing/Edits/", 2),
      r("wr_003", "Publisher Contract", "writer",
        [F(["publishing contract", "book deal", "advance", "royalties", "agent"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Business/Contracts/", 3),
      r("wr_004", "Research Material", "writer",
        [F(["research", "notes", "source material", "reference"])], "OR",
  ...
  videographer: {
    ...
    rules: [
      r("vid_001", "Project / Sequence File", "videographer",
        [E([".prproj", ".aep", ".drp", ".fcpbundle"]), F(["project", "sequence"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Projects/", 1),
      r("vid_002", "Client Brief", "videographer",
        [F(["brief", "creative brief", "shot list", "storyboard"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Clients/Briefs/", 2),
      r("vid_003", "Stock Footage", "videographer",
        [D(["videoblocks.com", "storyblocks.com", "artgrid.io", "pond5.com", "shutterstock.com"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Assets/Stock/", 3),
      r("vid_004", "Delivery Receipt / Invoice", "videographer",
        [F(["delivery", "invoice", "final delivery", "handoff"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Finance/Invoices/", 4),
    ]
  },
  ...
  crafter: {
    ...
    rules: [
      r("cr_001", "Pattern / SVG / Design", "crafter",
        [E([".svg", ".pdf", ".dxf", ".png"]), F(["pattern", "template", "design", "cut file"])], "OR",
      ...
      r("cr_003", "Shipping Label", "crafter",
        [F(["shipping label", "postage", "packing slip"])], "OR",
        "Label_[YYYY-MM-DD]", "Shop/Labels/", 3),
      r("cr_004", "Supplier Invoice", "crafter",
        [F(["supplier", "wholesale", "invoice", "materials"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Finance/Suppliers/", 4),
    ]
  },
  ...
  gardener: {
    ...
    rules: [
      r("gar_001", "Planting Schedule", "gardener",
        [F(["planting schedule", "sowing", "planting plan", "calendar"])], "OR",
  ...
  date_first: {
    ...
    rules: [
      ...
      r("df_002", "Date-prefix all Office docs", "date_first",
        [E([".docx", ".xlsx", ".pptx", ".doc", ".xls", ".ppt"])], "OR",
  ...
  by_source: {
    ...
    rules: [
      r("bs_001", "Google files", "by_source",
        [D(["google.com", "docs.google.com", "drive.google.com", "sheets.google.com"])], "OR",
  ...
  version_control: {
    ...
    rules: [
      r("vc_001", "Add version suffix to documents", "version_control",
        [F(["v1", "v2", "v3", "version", "rev_", "revision", "draft"])], "OR",
        "[page_title]_[YYYY-MM-DD]", "Versioned/", 1),
      r("vc_002", "Version software releases", "version_control",
        [F(["release", "changelog", "patch notes"]), E([".zip", ".dmg", ".exe"])], "OR",
  ...
  cleanup_only: {
    ...
    rules: [
      r("cl_001", "Clean all downloads in place", "cleanup_only",
        [E([".pdf", ".docx", ".xlsx", ".pptx", ".csv", ".zip", ".png", ".jpg"])], "OR",
...
// First 6 packs are available on the free tier; rest require Pro
export const FREE_PACKS: PersonaPack[] = [
  "student", "developer", "personal_health", "finance", "traveler", "homeowner"
]

export function isPackFree(id: PersonaPack): boolean {
  return FREE_PACKS.includes(id)
}
